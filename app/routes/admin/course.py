...
class CourseModelView(BaseModelView):
	...
	column_details_list = [
		"id", "code", "number", "subject", "name", "units", "repeat", "countgpa", "desc", "notes", "prereqs", "coreqs", "antireqs", "url", "url_uni", "old"
	]
	column_filters = ["number", "name", "units", "subject_id", "subject", "calversion", "old"]
